...
(
    ...
    `state`                tinyint(2)           DEFAULT 0 COMMENT '状态 0初始化，1组合成功，2分解成功，3组合无效，4分解无效',
    `background_id`        bigint(20)           DEFAULT 0 COMMENT '背景id',
    `fur_id`               bigint(20)           DEFAULT 0 COMMENT '皮毛id',
    `facial_id`            bigint(20)           DEFAULT 0 COMMENT '表情id',
    ...
    `background`           varchar(64)          DEFAULT NULL COMMENT '背景',
    `fur`                  varchar(64)          DEFAULT NULL COMMENT '皮毛',
    `facial`               varchar(64)          DEFAULT NULL COMMENT '表情',
    `head`                 varchar(64)          DEFAULT NULL COMMENT '头部',
    `accessories`          varchar(64)          DEFAULT NULL COMMENT '配饰',
    `eyes`                 varchar(64)          DEFAULT NULL COMMENT '眼部',
    `clothes`              varchar(64)          DEFAULT NULL COMMENT '衣服',
    `hat`                  varchar(64)          DEFAULT NULL COMMENT '帽子',
    `costume`              varchar(64)          DEFAULT NULL COMMENT '服装',
    `makeup`               varchar(64)          DEFAULT NULL COMMENT '妆容',
    `shoes`                varchar(64)          DEFAULT NULL COMMENT '鞋子',
    `mouth`                varchar(64)          DEFAULT NULL COMMENT '嘴',
    `earring`              varchar(64)          DEFAULT NULL COMMENT '耳环',
    `necklace`             varchar(64)          DEFAULT NULL COMMENT '项链',
    `neck`                 varchar(64)          DEFAULT NULL COMMENT '颈部',
    `hair`                 varchar(64)          DEFAULT NULL COMMENT '头发',
    `horn`                 varchar(64)          DEFAULT NULL COMMENT '角',
    `hands`                varchar(64)          DEFAULT NULL COMMENT '手',
    `body`                 varchar(64)          DEFAULT NULL COMMENT '身体',
    `skin`                 varchar(64)          DEFAULT NULL COMMENT '皮肤',
    `tattoo`               varchar(64)          DEFAULT NULL COMMENT '纹身',
    `people`               varchar(64)          DEFAULT NULL COMMENT '人物',
    `characteristic`       varchar(64)          DEFAULT NULL COMMENT '性格',
    `hobby`                varchar(64)          DEFAULT NULL COMMENT '爱好',
    `zodiac`               varchar(64)          DEFAULT NULL COMMENT '星座',
    `action`               varchar(64)          DEFAULT NULL COMMENT '动作',
    `toys`                 varchar(64)          DEFAULT NULL COMMENT '玩具',
    `fruits`               varchar(64)          DEFAULT NULL COMMENT '水果',
    `vegetables`           varchar(64)          DEFAULT NULL COMMENT '蔬菜',
    `meat`                 varchar(64)          DEFAULT NULL COMMENT '肉类',
    `beverages`            varchar(64)          DEFAULT NULL COMMENT '饮料',
    `food`                 varchar(64)          DEFAULT NULL COMMENT '食物',
    `vehicle`              varchar(64)          DEFAULT NULL COMMENT '交通工具',
    `weather`              varchar(64)          DEFAULT NULL COMMENT '天气',
    `month`                varchar(64)          DEFAULT NULL COMMENT '月份',
    `sports`               varchar(64)          DEFAULT NULL COMMENT '运动',
    `music`                varchar(64)          DEFAULT NULL COMMENT '音乐',
    `movies`               varchar(64)          DEFAULT NULL COMMENT '电影',
    `season`               varchar(64)          DEFAULT NULL COMMENT '季节',
    `outfit`               varchar(64)          DEFAULT NULL COMMENT '搭配',
    `face`                 varchar(64)          DEFAULT NULL COMMENT '五官',
    `arm`                  varchar(64)          DEFAULT NULL COMMENT '手臂',
    `leg`                  varchar(64)          DEFAULT NULL COMMENT '腿部',
    `foot`                 varchar(64)          DEFAULT NULL COMMENT '脚',
    `weapon`               varchar(64)          DEFAULT NULL COMMENT '武器',
    `helmet`               varchar(64)          DEFAULT NULL COMMENT '头盔',
    `armor`                varchar(64)          DEFAULT NULL COMMENT '盔甲',
    `mecha`                varchar(64)          DEFAULT NULL COMMENT '机甲',
    `pants`                varchar(64)          DEFAULT NULL COMMENT '裤子',
    `skirt`                varchar(64)          DEFAULT NULL COMMENT '裙子',
    `background_score`     decimal(18, 9)       DEFAULT 0 COMMENT '背景score',
    `fur_score`            decimal(18, 9)       DEFAULT 0 COMMENT '皮毛score',
    `facial_score`         decimal(18, 9)       DEFAULT 0 COMMENT '表情score',
    `head_score`           decimal(18, 9)       DEFAULT 0 COMMENT '头部score',
    `accessories_score`    decimal(18, 9)       DEFAULT 0 COMMENT '配饰score',
    `eyes_score`           decimal(18, 9)       DEFAULT 0 COMMENT '眼部score',
    `clothes_score`        decimal(18, 9)       DEFAULT 0 COMMENT '衣服score',
    `hat_score`            decimal(18, 9)       DEFAULT 0 COMMENT '帽子score',
    `costume_score`        decimal(18, 9)       DEFAULT 0 COMMENT '服装score',
    `makeup_score`         decimal(18, 9)       DEFAULT 0 COMMENT '妆容score',
    `shoes_score`          decimal(18, 9)       DEFAULT 0 COMMENT '鞋子score',
    `mouth_score`          decimal(18, 9)       DEFAULT 0 COMMENT '嘴score',
    `earring_score`        decimal(18, 9)       DEFAULT 0 COMMENT '耳环score',
    `necklace_score`       decimal(18, 9)       DEFAULT 0 COMMENT '项链score',
    `neck_score`           decimal(18, 9)       DEFAULT 0 COMMENT '颈部score',
    `hair_score`           decimal(18, 9)       DEFAULT 0 COMMENT '头发score',
    `horn_score`           decimal(18, 9)       DEFAULT 0 COMMENT '角score',
    `hands_score`          decimal(18, 9)       DEFAULT 0 COMMENT '手score',
    `body_score`           decimal(18, 9)       DEFAULT 0 COMMENT '身体score',
    `skin_score`           decimal(18, 9)       DEFAULT 0 COMMENT '皮肤score',
    `tattoo_score`         decimal(18, 9)       DEFAULT 0 COMMENT '纹身score',
    `people_score`         decimal(18, 9)       DEFAULT 0 COMMENT '人物score',
    `characteristic_score` decimal(18, 9)       DEFAULT 0 COMMENT '性格score',
    `hobby_score`          decimal(18, 9)       DEFAULT 0 COMMENT '爱好score',
    `zodiac_score`         decimal(18, 9)       DEFAULT 0 COMMENT '星座score',
    `action_score`         decimal(18, 9)       DEFAULT 0 COMMENT '动作score',
    `toys_score`           decimal(18, 9)       DEFAULT 0 COMMENT '玩具score',
    `fruits_score`         decimal(18, 9)       DEFAULT 0 COMMENT '水果score',
    `vegetables_score`     decimal(18, 9)       DEFAULT 0 COMMENT '蔬菜score',
    `meat_score`           decimal(18, 9)       DEFAULT 0 COMMENT '肉类score',
    `beverages_score`      decimal(18, 9)       DEFAULT 0 COMMENT '饮料score',
    `food_score`           decimal(18, 9)       DEFAULT 0 COMMENT '食物score',
    `vehicle_score`        decimal(18, 9)       DEFAULT 0 COMMENT '交通工具score',
    `weather_score`        decimal(18, 9)       DEFAULT 0 COMMENT '天气score',
    `month_score`          decimal(18, 9)       DEFAULT 0 COMMENT '月份score',
    `sports_score`         decimal(18, 9)       DEFAULT 0 COMMENT '运动score',
    `music_score`          decimal(18, 9)       DEFAULT 0 COMMENT '音乐score',
    `movies_score`         decimal(18, 9)       DEFAULT 0 COMMENT '电影score',
    `season_score`         decimal(18, 9)       DEFAULT 0 COMMENT '季节score',
    `outfit_score`         decimal(18, 9)       DEFAULT 0 COMMENT '搭配score',
    `face_score`           decimal(18, 9)       DEFAULT 0 COMMENT '五官score',
    `arm_score`            decimal(18, 9)       DEFAULT 0 COMMENT '手臂score',
    `leg_score`            decimal(18, 9)       DEFAULT 0 COMMENT '腿部score',
    `foot_score`           decimal(18, 9)       DEFAULT 0 COMMENT '脚score',
    `weapon_score`         decimal(18, 9)       DEFAULT 0 COMMENT '武器score',
    `helmet_score`         decimal(18, 9)       DEFAULT 0 COMMENT '头盔score',
    `armor_score`          decimal(18, 9)       DEFAULT 0 COMMENT '盔甲score',
    `mecha_score`          decimal(18, 9)       DEFAULT 0 COMMENT '机甲score',
    `pants_score`          decimal(18, 9)       DEFAULT 0 COMMENT '裤子score',
    `skirt_score`          decimal(18, 9)       DEFAULT 0 COMMENT '裙子score',
