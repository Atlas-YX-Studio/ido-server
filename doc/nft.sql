...
(
    ...
    sell_price  DECIMAL(36, 9) DEFAULT 0 COMMENT '售价',
    offer_price DECIMAL(36, 9) DEFAULT 0 COMMENT '报价，0暂无报价，大于0为当前最高出价',
...
(
    ...
    selling_price DECIMAL(36, 9) DEFAULT 0 COMMENT '报价',
