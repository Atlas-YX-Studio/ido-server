...
CREATE TABLE ido_dx_product (
    ...
    raiseTotal DECIMAL(38,9) DEFAULT 0 COMMENT '筹集总量',
    currencyTotal DECIMAL(38,9) DEFAULT 0 COMMENT '代币预发行总量',
    saleTotal DECIMAL(38,9) DEFAULT 0 COMMENT '总销售量',
...
CREATE TABLE ido_dx_user_record (
    ...
    amount DECIMAL(38,9) NOT NULL COMMENT '该用户质押量',
    tokenAmount DECIMAL(38,9) DEFAULT -1 COMMENT '链上实际质押量',
    gasCost DECIMAL(38,9) DEFAULT -1 COMMENT 'gas费用',
...
CREATE TABLE swap_user_record (
        ...
        tokenInX DECIMAL(38,9) DEFAULT 0 COMMENT 'x注入量',
        tokenInY DECIMAL(38,9) DEFAULT 0 COMMENT 'y注入量',
        tokenOutX DECIMAL(38,9) DEFAULT 0 COMMENT 'x提取量',
        tokenOutY DECIMAL(38,9) DEFAULT 0 COMMENT 'y提取量',
        reserveAmountX DECIMAL(38,9) DEFAULT 0 COMMENT 'x储备量',
        reserveAmountY DECIMAL(38,9) DEFAULT 0 COMMENT 'y储备量',
...
CREATE TABLE liquidity_user_record (
      ...
      amountX DECIMAL(38,9) DEFAULT 0 COMMENT 'x注入/提取量',
      amountY DECIMAL(38,9) DEFAULT 0 COMMENT 'y注入/提取量',
      reserveAmountX DECIMAL(38,9) DEFAULT 0 COMMENT 'x储备量',
      reserveAmountY DECIMAL(38,9) DEFAULT 0 COMMENT 'y储备量',
